...
let message=document.getElementById("messagep");
let a=Math.random()*100;
random.innerHTML=Math.floor(a);
let bestsc=document.getElementById("bestscorenum");
...
Draw();
 ...
 input.value=null; 
    ...
    message.innerHTML="Suspected number is greater,Try again";
 input.value=null; 
}
}else{
    alert("put the number between 0 to 100");
    input.value=null;
}
count++;
z++;
